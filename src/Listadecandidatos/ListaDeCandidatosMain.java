...
public class ListaDeCandidatosMain {
    public static void main(String[] args) {
        ...
        System.out.print("Você gostaria de adicionar algum candidato a sua lista ([1] - sim / [2] - não): ");
        respostaDoUsuario = input.nextInt();

        if (respostaDoUsuario == 1) {
            do {
                candidatos.adicionarCandidatos();
                System.out.print("Você gostaria de adicionar mais algum candidato em sua lista? ([1] - sim [2] - não): ");
                respostaDoUsuario = input.nextInt();
        ...
        System.out.println("\nVolte sempre, agradecemos por ser a sua preferência <3 ");
        System.out.println("A sua lista após as atualizações: " + candidatos.getCandidatos());
